...
### I’ve been introducing the idea of Consequence Design over the past several years. I’m using this site as a holding place for talks and additional writing on the subject.
...
**Consequence Design** says that we have to accept that every time we add a tech layer to everyday experiences, that we're adding complexity -- and consequences -- to an experience that it wasn't designed for. It would help if we'd reinvent that experience to accommodate these changes, but every time you see a long-time at your favorite fast-food spot, you're experiencing the consequence of bad design without even realizing it.&#x20;
